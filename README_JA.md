...
```python
your_maneuver.transprocess(out_type=0)   # 静止画連番
your_maneuver.transprocess(out_type=1)   # H.264 SDR 8bit .mp4（デフォルト）
your_maneuver.transprocess(out_type=3)   # ProRes 422 HQ 10bit .mov（HDRアーカイブ推奨）
```
